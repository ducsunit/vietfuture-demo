...
<head>
    ...
    <style>
        ...
        .register-icon {
            ...
            font-size: 1.75rem;
            box-shadow: 0 10px 25px rgba(0, 169, 255, 0.25);
        ...
        .register-btn {
            ...
            cursor: pointer;
            transition: all 0.3s ease;
            box-shadow: 0 10px 25px rgba(0, 169, 255, 0.35);
            position: relative;
            overflow: hidden;
            margin-top: 1rem;
        }
                ...
                <div class="form-fields-container">
                    ...
                    <div class="form-field-wrapper">
                        <div class="age-input-group">
                            <div class="form-group-with-icon" data-icon="">
                                <input type="text" name="age" class="form-input" placeholder="Tuổi (ví dụ: 8-10)"
